    ...
    return (
      <View style={{flex:1,backgroundColor:'white'}}>
          ...
          <View style={{height:25,width:70,borderColor:'green',borderWidth:1,marginLeft:20,marginTop:10,backgroundColor:'#45CE30',opacity:.1}}>
             ...
             <Text style={{fontSize:15,textAlign:'center',marginTop:-23,color:'gray',marginLeft:-250}}>Fortune</Text>
          
          <Text style={{fontSize:15,marginLeft:15,marginTop:10}}> Fortune Sun Lite Refined Oil, 5L - Can</Text>
          ...
          <View style={{flexDirection:'row',height:60,width:'100%'}}>
              ...
              <Text style={{fontSize:10,marginLeft:3,marginTop:0,color:'gray'}}>15679 Ratings & 35 Reviews </Text>
              </View>

          </View>

          <View style={{height:330,width:'100%',}}>
            <ImageBackground  source={require('../Component/Images/fortt.jpg')} style={{ resizeMode: 'contain',width: '95%', height: '100%',marginLeft:15}}>
             </ImageBackground>
          ...
          <Text style={{fontSize:25,color:'green',margin:5,fontWeight:'bold'}}> 4.3 <Icon name="star" size={20} style={{color:'green'}} /></Text>
          <Text style={{fontSize:15,marginLeft:10,marginTop:0,color:'gray'}}>15679 Ratings & 31 Reviews </Text>
